function notifyMe(message, status, progress) {
      ...
      function check(cc2, separador, id) {
                    ...
                    xmlhttp.onreadystatechange = function()
                    {
                      ...
                      } else if (xdata.match("CVV2 Disapproved")) {
                          document.getElementById("demo").innerHTML = 'CVV2 DISAPPROVED !';
                          document.getElementById("testado").innerHTML = (eval(document.getElementById("testado").innerHTML) + 1);
                          document.getElementById("CCVV").innerHTML = (eval(document.getElementById("CCVV").innerHTML) + 1);
                          document.getElementById("cvv_conta").innerHTML = (eval(document.getElementById("cvv_conta").innerHTML) + 1);
                          $("#cvvsapp").append(xdata);
                          rmLinha('#lista');
                          console.log('{"Success":"', document.getElementById("testado").innerHTML, '":"false"}')

                      } else if (xdata.match("Disapproved")) {
                          document.getElementById("demo").innerHTML = 'DISAPPROVED !';
                          document.getElementById("testado").innerHTML = (eval(document.getElementById("testado").innerHTML) + 1);
